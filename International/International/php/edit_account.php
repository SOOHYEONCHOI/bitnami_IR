<?php
  ...
  $conn = mysqli_connect('localhost', 'root', 'asd123', 'drunkencode') or die("Failed");
	$sql = "SELECT username, email, firstname, lastname, phoneNum, ulevel, staffNum, street, city, state, zipcode from user_account where username = '$username_d'";
 		...
 		<div class="container">
 			<div class="row">
 				<div class="col-md-9 animate-box">
 					...
 					<h4>Complete the form below to edit user account.</h4>
 					<form action="edit_account_upload.php" method="POST">
            <div class="row form-group">
							<div class="col-md-6">
								<label for="username">Username : <a><?php echo $Username ?></a></label>
							</div>
            </div>
            <div class="row form-group">
              <div class="col-md-6">
                <label for="email">Email : <a><?php echo $Email ?></a></label>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-6">
                <label for="firstname">First name : <a><?php echo $Firstname ?></a></label>
              </div>
              <div class="col-md-6">
                <label for="lastname">Last name : <a><?php echo $Lastname ?></a> </label>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-6">
                <label for="staffnumber">Staffnumber : <a><?php echo $Staffnum ?></a></label>
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-2">
                <label for="ulevel">User Level</label> <input type="text" name="ulevel" class="form-control" placeholder="<?php echo $Ulevel ?>">
              </div>
            </div>
 						<div class="row form-group">
 							<div class="col-md-6">
 								<label for="lname">Phone number</label>
 								<input type="text" name="phonenumber" class="form-control" placeholder="<?php echo $Phonenum ?>">
 							</div>
 						</div>
 						<div class="row form-group">
 							<div class="col-md-6">
 							...
 							<div class="col-md-6">
 								...
 								<input type="password" name="rpassword" class="form-control" placeholder="Re-enter Password">
 							</div>
 						</div>
            <div>
              <a>Address</a>
            ...
            <div class="row form-group">
              ...
              <div class="col-md-3">
                ...
                <input type="text" name="zipcode" class="form-control" placeholder="<?php echo $Zipcode ?>">
              </div>
            </div>
