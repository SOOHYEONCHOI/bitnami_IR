<?php
 ...
 $sql = "SELECT res_ID, location, res_date, res_time, seat, adults, child, username from res_history where username = '$username_d'";
 ...
 while($data = mysqli_fetch_array($result)){
   $res_ID[$i] = $data[res_ID];
   $location[$i] = $data[location];
   $res_date[$i] = $data[res_date];
   $res_time[$i] = $data[res_time];
   $seat[$i] = $data[seat];
